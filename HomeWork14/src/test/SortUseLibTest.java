...
import ru.aryukov.SorterUseLibs;
...
/**
 * Created by oaryukov on 26.08.2017.
 */
public class SortUseLibTest{
    ...
    public void testSort() {
        ...
        SorterUseLibs.quicksort(values);
        // Assert equality.
    ...
    public void largeTestSort() {
        ...
        Integer[] values = new Integer[8192000];
        ...
        // Copy the values into a new array to sort with Java's built in implementation for comparison
        Integer[] sortedValues = new Integer[8192000];
