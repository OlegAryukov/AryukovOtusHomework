...
public class AdminServlet extends HttpServlet {
    ...
    @Autowired
    private UserCacheMessage userEntityCache;
    ...
    private Map<String, Object> createPageVariablesMap(HttpServletRequest request) {
        ...
        pageVariables.put("hitCount", userEntityCache.getCacheInfo().getHitCount());
        pageVariables.put("missCount", userEntityCache.getCacheInfo().getMissCount());
