...
import static ru.aryukov.mesurment.ObjectSizeInstrument.sizeOf;
/**
 * Created by olega on 11.04.17.
 */
@RunWith(Parameterized.class)
public class ObjectSizeMesurmentTest {
    private final Object object;
    private final String tcName;
    private final long result64bit;
    private final long result32bit;

    public ObjectSizeMesurmentTest(Object object, String tcName, long result64bit, long result32bit) {
        this.object = object;
        this.tcName = tcName;
